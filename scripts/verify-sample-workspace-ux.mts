...
assert.doesNotMatch(workspace, /Calculated Weight/);
assert.match(workspace, /<span>Quantity<\/span>/);
assert.match(workspace, /"Profile Default"/);
assert.match(workspace, /"Authored"/);
assert.match(workspace, /"Modified"/);
assert.match(workspace, /"Restored"/);
assert.match(workspace, /Use profile default/);
assert.match(workspace, /Use calculated value/);
assert.match(workspace, /Entered for this Sample/);
assert.match(workspace, /Overrides the calculated Aggregate quantity/);
assert.match(workspace, /Calculated from/);
assert.match(workspace, /row\.componentRole === "resin" \|\| row\.componentRole === "hardener"/);
