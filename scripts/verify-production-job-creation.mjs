...
assert.match(creator, /name: metadata\.jobName\.trim\(\)/);
assert.match(creator, /customer: metadata\.customer\.trim\(\) \|\| null/);
assert.match(creator, /job_number: metadata\.jobNumber\.trim\(\) \|\| null/);
assert.match(creator, /estimate_number: metadata\.estimateNumber\.trim\(\) \|\| null/);
assert.match(creator, /work_order_number: metadata\.workOrderNumber\.trim\(\) \|\| null/);
assert.match(creator, /color_plate_number: metadata\.plateNumber\.trim\(\) \|\| null/);
assert.match(creator, /\['jobNumber','Job number'\]/);
assert.match(creator, /\['jobName','Job name'\]/);
assert.match(creator, /\['customer','Customer'\]/);
assert.match(creator, /\['estimateNumber','Estimate number'\]/);
assert.match(creator, /\['workOrderNumber','Work order number'\]/);
assert.match(creator, /\['plateNumber','Plate number'\]/);
