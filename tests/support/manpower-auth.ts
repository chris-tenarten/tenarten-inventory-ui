...
export async function mockManpowerAuth(page: Page, role = 'lead', userId = '00000000-0000-0000-0000-000000000004') {
  ...
  const user = { id: userId, aud: 'authenticated', role: 'authenticated', email: 'fixture@example.invalid', app_metadata: {}, user_metadata: {}, created_at: '2026-09-21T00:00:00Z' };
