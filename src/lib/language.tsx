...
const english = {
  ...
  "shell.internalAccess": "Internal Access",
  "shell.password": "Password",
  "shell.unlockWorkspace": "Unlock Workspace",
  "shell.enterPassword": "Enter password",
  "shell.unlock": "Unlock",
  "shell.cancel": "Cancel",
  "shell.incorrectPassword": "Incorrect password.",
  "shell.logout": "Logout",
...
const spanish: Record<TranslationKey, string> = {
  ...
  "shell.internalAccess": "Acceso interno",
  "shell.password": "Contraseña",
  "shell.unlockWorkspace": "Desbloquear espacio de trabajo",
  "shell.enterPassword": "Ingresar contraseña",
  "shell.unlock": "Desbloquear",
  "shell.cancel": "Cancelar",
  "shell.incorrectPassword": "Contraseña incorrecta.",
