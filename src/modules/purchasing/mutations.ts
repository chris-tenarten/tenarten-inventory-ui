...
export function purchaseOrderDraftPdfInput(draft: PurchaseOrderDraft) {
  ...
  const orderSnapshot = {
    ...
    pdf_text_size:normalizePdfTextSize(draft.pdfTextSize),
