...
export type SampleBlendRow={id:string;percentage:string;color:string;size:string;materialType:string;quantity:string;unit:string;vendor:string;catalogSource:'standard'|'specialty'|null;catalogItemId:string|null;catalogSnapshot:Record<string,unknown>;displayOrder:number;componentRole:'aggregate'|'resin'|'hardener'|'other';calculationBasis:'target_total'|null;quantityProvenance:'calculated'|'manual';calculatedQuantity:string};
