  ...
  return (
    ...
    >
      ...
      {(display === "overview-slots" || summary.openFollowUpCount > 0) && (
        <span data-job-updates-attention className={`inline-flex h-full shrink-0 items-center justify-center gap-1 border-l ${display === "overview-slots" ? `w-12 ${summary.openFollowUpCount ? "border-amber-200 bg-amber-50/70 text-amber-900" : "border-slate-200 text-slate-400"}` : "border-amber-200 bg-amber-50/70 px-1.5 text-amber-900"}`}>
          <Flag
