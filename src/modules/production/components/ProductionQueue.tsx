        ...
        {overviewJobs.map((job) => {
          ...
          return (
            ...
            >
              ...
              <span className="pointer-events-none relative z-10 hidden whitespace-nowrap text-xs md:block">{job.requested_delivery_date ?? 'Delivery not set'}</span>
